...
def test_compute_summary_basic() -> None:
    ...
    # First frame is excluded from state-based stats.
...
def test_compute_summary_maps_unknown_to_neutral() -> None:
    ...
    # dt = [1, 1, 1] for this synthetic timeline; first frame excluded from state stats.
    assert summary["time_ch1_s"] == 1.0
